	...
	class THB_TextBoxBlock extends THB_BuilderBlock {
		...
		private function buildModals()
		{
			$thb_modal = new THB_Modal( $this->getTitle(), $this->getSlug() );
				...
				$thb_modal_container = $thb_modal_tab->createContainer( __( 'Primary', 'thb_text_domain' ), $this->getSlug() . '_action_container' );
				...
				$thb_modal_container = $thb_modal_tab->createContainer( __( 'Secondary', 'thb_text_domain' ), $this->getSlug() . '_action_container' );
