...
$thb_page = $thb_theme->getAdmin()->getMainPage();
	...
	$thb_container = $thb_tab->createContainer( __( 'Layout options', 'thb_text_domain' ), 'layout_social_footer' );
		...
		$thb_field = new THB_SelectField( 'header_position' );
			$thb_field->setLabel( __( 'Header position', 'thb_text_domain' ) );
			$thb_field->setOptions(array(
				'header-static' => __('Static', 'thb_text_domain'),
				'header-fixed'  => __('Fixed', 'thb_text_domain')
			));
		$thb_container->addField($thb_field);
